...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGVtb3JnYW5hZmFyaSIsImEiOiJjbDd0ZHF0azgwZnVjM3dxbmljNXMyMmN1In0.ZSd25nqjQw_hQOJHcHN4vQ'; //a

  var map = new mapboxgl.Map({
    container: 'map',
    scrollZoom: false //   style: 'mapbox://styles/demorganafari/cl6hgewt3000g14ql2t8ito6c',
...
// type is either 'password' or 'data'-a
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LeApTBsd3532bfCTi1JFDJFXTzubSOJYOM56ZRcnJ4U8d6siSijHJzh9IUvEpjsfhYdO8hc7DG9IsgfByx4hQBU00r0vX8nAD'); //1) Get checkout session from API-a
